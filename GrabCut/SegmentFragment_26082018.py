...
base_path = '/Users/adiel/temp/DSS/MR/'
out_path = base_path
list_to_process = 'p589'  # file with .txt extension
...
if RUNFROMTEXTFILE:
    ...
    outpathfrag = out_path+'results/'+list_to_process+'_gc/'
    outcords = out_path+'results/'+list_to_process+'_cords/'
    onlycolorimgs = text_file.readlines()
else:
    imgpath = '/Users/adiel/Dropbox/temp/anna_331_2/images/'
    outpath = '/Users/adiel/Dropbox/temp/anna_331_2/output/'
    outpathfrag = '/Users/adiel/Dropbox/temp/anna_331_2/fragments/'
...
#for j in range(0, 1):
   ...
   #     continue
    ...
    ret3, imbinary = cv2.threshold(blur, BINARIZATION_THRESHOLD, 255, cv2.THRESH_BINARY)
...
# apply CC mask
   ...
   # img1 = cv2.bitwise_and(img[:,:,0], ccmask_croped)
    ...
    outimgname = imgname[0:-5]+'_SC'+str(1/resize_factor)+'_gc_rect.png'
